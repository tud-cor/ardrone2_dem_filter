...
for t = 1:size(state,2)
    ...
    rotor1B = [rotor1AxisB(1,2)+r*cos(omegaT);rotor1AxisB(2,2)+r*sin(omegaT);zeros(1,nCircleSamples);ones(1,nCircleSamples)];
    rotor2B = [rotor2AxisB(1,2)+r*cos(omegaT);rotor2AxisB(2,2)+r*sin(omegaT);zeros(1,nCircleSamples);ones(1,nCircleSamples)];
    rotor3B = [rotor3AxisB(1,2)+r*cos(omegaT);rotor3AxisB(2,2)+r*sin(omegaT);zeros(1,nCircleSamples);ones(1,nCircleSamples)];
    rotor4B = [rotor4AxisB(1,2)+r*cos(omegaT);rotor4AxisB(2,2)+r*sin(omegaT);zeros(1,nCircleSamples);ones(1,nCircleSamples)];
...
%     r1 = plot3(rotor1AxisI(1,2),rotor1AxisI(2,2),rotor1AxisI(3,2),'o','Color','b',...
%                'MarkerSize',20);
%     r2 = plot3(rotor2AxisI(1,2),rotor2AxisI(2,2),rotor2AxisI(3,2),'o','Color','g',...
%                'MarkerSize',20);
%     r3 = plot3(rotor3AxisI(1,2),rotor3AxisI(2,2),rotor3AxisI(3,2),'o','Color','r',...
%                'MarkerSize',20);
%     r4 = plot3(rotor4AxisI(1,2),rotor4AxisI(2,2),rotor4AxisI(3,2),'o','Color','k',...
%                'MarkerSize',20);
    ...
    r1g = plot3(rotor1I(1,:),rotor1I(2,:),zeros(1,nCircleSamples),'-','Color',[17,17,17]/255,'LineWidth',1);
    r2g = plot3(rotor2I(1,:),rotor2I(2,:),zeros(1,nCircleSamples),'-','Color',[17,17,17]/255,'LineWidth',1);
    r3g = plot3(rotor3I(1,:),rotor3I(2,:),zeros(1,nCircleSamples),'-','Color',[17,17,17]/255,'LineWidth',1);
    r4g = plot3(rotor4I(1,:),rotor4I(2,:),zeros(1,nCircleSamples),'-','Color',[17,17,17]/255,'LineWidth',1);
