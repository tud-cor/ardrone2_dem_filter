...
if if_cause
    ...
    [output.DEM_t,output.DEMv_x,output.Y_embed] = D_step_causes(model.A,brain.D_A,model.B,brain.Da,brain.Bt,brain.Ct,...
    ...
    if_causes = 1;
    output.kalmfv_x = kalman_discrete(model.A,model.B,model.C,model.process_y,...
...
%         brain.Pw,brain.Pz,model.real_cause,model.process_y,model.t,brain.nx);
    ...
    output.kalman_x = kalman_discrete(model.A,model.B,model.C,model.process_y,...
        brain.Pz,brain.Pw,model.sam_time,model.t,model.real_cause,if_causes);
%     output.kalman_x = KF_causes(model.A,model.B,model.C,brain.nv,brain.ny,model.sam_time,...
%         brain.Pw,brain.Pz,model.real_cause,model.process_y,model.t,brain.nx);
end
